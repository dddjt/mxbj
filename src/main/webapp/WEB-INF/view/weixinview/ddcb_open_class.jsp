			...
			<div id="slider" class="mui-slider"
				...
				<div class="mui-slider-group mui-slider-loop">
					...
					<div
						...
						<a href="#"> <img
							src="http://www.dreamnotechina.com/files/bannerimgs/banner4.jpg">
						</a>
					</div>
					<!-- 第一张 -->
					<div
						...
						<a href="#"> <img
							src="http://www.dreamnotechina.com/files/bannerimgs/banner1.jpg">
						</a>
					</div>
					<!-- 第二张 -->
					<div
						...
						class="mui-slider-item">
						<a href="#"> <img
							src="http://www.dreamnotechina.com/files/bannerimgs/banner2.jpg">
						</a>
					</div>
					<!-- 第三张 -->
					<div
						...
						class="mui-slider-item">
						<a href="#"> <img
							src="http://www.dreamnotechina.com/files/bannerimgs/banner3.jpg">
						</a>
					</div>
					<!-- 第四张 -->
					<div
