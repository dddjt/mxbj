...
public class ImageSnapshot {
	public static byte[] resize(BufferedImage srcBufferedImage, int targetWidth)
		  ...
		  public static void main(String[] args) throws IOException {
		    ...
		    File originalImage = new File("C:\\Users\\Administrator\\Desktop\\test.jpg");
		    byte[] bytes = resize(ImageIO.read(originalImage), 80, 0.1f, false);
		    FileOutputStream out = new FileOutputStream(new File("C:\\Users\\Administrator\\Desktop\\final.jpg"));
		    out.write(bytes);
		    out.close();
