...
public class WeixinPayUtils {
	...
	private static String appid = "wx519f44ba99e2ec36";
	private static String appsecret = "1f0e5a7cd452b7c673611e55fd05ea75";
	private static String partner = "1346782801";
	// 这个参数partnerkey是在商户后台配置的一个32位的key,微信商户平台-账户设置-安全设置-api安全
	private static String partnerkey = "8A95BD7E524BFCBD8CBE4C9069D8499E";
	// openId 是微信用户针对公众号的标识，授权的部分这里不解释
	private static String openId = "";
	// 微信支付成功后通知地址 必须要求80端口并且地址不能带参数
	private static String notifyurl = "http://www.dreamnotechina.com/weixinPayResult"; // Key
